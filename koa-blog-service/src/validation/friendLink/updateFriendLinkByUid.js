...
module.exports = (
    ...
    let _linkName = isEmpty(linkName) ? '' : linkName
    let _linkAddress = isEmpty(linkAddress) ? '' : linkAddress
    ...
    if (!_linkName) {
        return {
            errorMsg: 'linkName不能为空',
            isValid,
        }
    }
    if (!_linkAddress) {
        return {
            errorMsg: 'linkAddress不能为空',
            isValid,
        }
    }
